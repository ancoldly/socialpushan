    ...
    <div class="w-[45%] grid gap-[10px]">
        <div class="grid p-[20px] bg-white rounded-[10px]">
            <div class="grid gap-[20px]">
                ...
                <form id="biography-form" class="grid gap-[10px]" method="POST" action="{{ route('edit-biography') }}">
                    @csrf
                    <div class="grid gap-[20px]">
                        <p class="text-center biography">{{ $user->biography }}</p>
                        <div class="hidden edit-biography">
                            <div class="w-full border-[2px] p-[10px] rounded-[5px]">
                                <textarea name="biography" id="biography" class="outline-none text-center w-full h-[80px] resize-none">{{ $user->biography }}</textarea>
                                <p id="char-count" class="text-blue-500 font-semibold"></p>
                            </div>

                            <div class="text-right mt-[20px] flex gap-[10px]">
                                <button
                                    class="w-[30%] h-[40px] bg-gray-200 rounded-[5px] font-semibold text-[14px] cancel-biography"
                                    type="button">Cancel</button>
                                <button
                                    class="w-[30%] h-[40px] bg-gray-200 rounded-[5px] font-semibold text-[14px] save-biography"
                                    type="submit" name="save-biography">Save biography</button>
                            </div>
                        </div>
                    </div>

                    <button class="w-full h-[40px] bg-gray-200 rounded-[5px] font-semibold text-[14px] btn-biography"
                        type="button">Edit biography</button>
                </form>
        ...
        <div class="grid p-[20px] bg-white rounded-[10px] gap-[20px]">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-500 text-[14px] font-medium">{{ $images->count() }} Picture</p>
                </div>
                <a href="profile.images" class="font-semibold text-blue-500">See All Picture</a>
            </div>
        ...
        <div class="grid p-[20px] bg-white rounded-[10px] gap-[20px]">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-500 text-[14px] font-medium">{{ $acceptedFriends->count() }} Friends</p>
                </div>
                <a href="profile.friends" class="font-semibold text-blue-500">See All Friends</a>
            </div>
...
<div class="w-[55%] grid gap-[10px] relative" id="containerPost">
...
@if ($user->posts->count() > 0)
    @foreach ($posts as $post)
        @if ($post->user->id == Auth::id() && $post->group_id == null)
                        ...
                        <div class="flex gap-[20px] border-[2px] p-[10px] rounded-[10px] items-center">
                            ...
                            <div class="grid">
                                ...
                                <p class="text-[14px]">This error is often caused by the owner only
                                    sharing
                                    the content with a small group, changing who can see it, or deleting
                                    the
                                    content.</p>
                            </div>
                        </div>
